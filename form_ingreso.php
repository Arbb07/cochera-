    ...
    <form method="POST" action="registro_ingreso.php">
        <div class="container p-1">
            ...
            <div aria-live="polite" aria-atomic="true" class="d-flex justify-content-center align-items-center w-100">
                <div class="col-sm-12">
                    <input type="text" class="form-control" style="text-transform:uppercase" required name="inpt_placa" maxlength="8" onkeyup="javascript:this.value=this.value.toUpperCase();">
